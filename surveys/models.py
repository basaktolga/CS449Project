...
class ConsentFormContent(models.Model):
    title = models.CharField(max_length=1047, default=_("Consent Form"))
    content = models.TextField(help_text=_("The content of the consent form shown to users. You can use HTML for formatting."))
...
class Survey(BaseModel):
    ...
    # Link to the ConsentFormContent model
    consent_form = models.ForeignKey(ConsentFormContent, on_delete=models.SET_NULL, null=True, blank=True, related_name='surveys')
